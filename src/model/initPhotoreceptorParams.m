...
params.n = 3;       % cooperativity for cGMP->current
params.cdark = 1;  % dark calcium concentration
params.beta = 9;	  % rate constant for calcium removal in 1/sec
params.m = 4;  	  % cooperativity for cyclase, hill coef
params.kGC = 0.5;   % hill affinity for cyclase
...
switch modelType
    ...
    case 'primateRod'
        ...
        params.m = 4;        % cooperativity for cyclase, hill coef
        params.kGC = 0.5;  % affinity for Ca2+
    ...
    case 'mouseCone'
        ...
        params.m = 4;  	  % cooperativity for cyclase, hill coef
        params.kGC = 0.4;  % hill affinity for cyclase
        params.gamma = 10; % so stimulus can be in R*/sec (this is rate of increase in opsin activity per R*/sec)
    case 'mouseRod'
        ...
        params.beta = 25 ;	  % rate constant for calcium removal in 1/sec
        params.m = 4;  	  % cooperativity for cyclase, hill coef
        params.kGC = 0.40;		% affinity for Ca2+
